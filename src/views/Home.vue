      ...
      <div>
        ...
        <div class="mb-10">
          ...
          <ul v-else-if="isStudent" class="list-disc list-inside">
            ...
            <li>
              <router-link :to="{ name: 'ProfileEdit', params: { step: 'schritt1' } }"
                >Profil bearbeiten (Schritt 1)</router-link
              >
            </li>
            <li>
              <router-link :to="{ name: 'ProfileEdit', params: { step: 'schritt2' } }"
                >Profil bearbeiten (Schritt 2)</router-link
              >
            </li>
            <li>
              <router-link :to="{ name: 'ProfileEdit', params: { step: 'schritt3' } }"
                >Profil bearbeiten (Schritt 3)</router-link
              >
            </li>
            <li>
              <router-link :to="{ name: 'ProfileEdit', params: { step: 'schritt4' } }"
                >Profil bearbeiten (Schritt 4)</router-link
              >
            </li>
            <li>
              <router-link :to="{ name: 'ProfileEdit', params: { step: 'schritt5' } }"
                >Profil bearbeiten (Schritt 5)</router-link
              >
            </li>
            <li>
              <router-link :to="{ name: 'ProfileEdit', params: { step: 'schritt6' } }"
